...
cask 'docker' # Docker
cask 'iterm2' unless system ".local/bin/installed iTerm.app" # iTerm2 unless already installed
...
# vscode 'misogi.ruby-rubocop' # Rubocop
# vscode 'shopify.ruby-lsp' # Ruby LSP
# vscode 'sissel.shopify-liquid' # Shopify Liquid
# vscode 'shopify.theme-check-vscode' # Shopify
# vscode 'mechatroner.rainbow-csv' # CSV
# vscode 'esbenp.prettier-vscode' # Prettier
# vscode 'yzhang.markdown-all-in-one' # Markdown
